...
window.addEventListener("DOMContentLoaded", () => {
    ...
    $(document).on("click", ".add-content-btn", async function () {
        ...
        try {
            ...
            addLog(
                `[INFO] Transaction hash successfully stored in Blockchain network with tx_hash: ${receipt.hash}, block_number: ${receipt.blockNumber}.`
            );
            addLog(
                `[SUCCESS] Deployment blockchain process completed successfully for user account ${signer.address ? signer.address : "error" }.`
            );
            ...
            Swal.fire({
                ...
                // Setelah user menekan tombol "OK"
